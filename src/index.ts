...
import { handlerCreateFeedFollow, handlerListFeedFollow, handlerUnfollowFeed } from "./commands/feed-follows";
...
async function main() {
	...
	registerCommand(commandsRegistry, "unfollow", middlewareLoggedIn(handlerUnfollowFeed));
